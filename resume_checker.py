...
Original file is located at
    https://colab.research.google.com/drive/1_PMtC7cRGHnh5n_Q8nneV9MDzJA10Mpd
"""
...
demo = gr.Interface(
    ...
    outputs=[
        ...
        gr.Markdown(label="Suggestions And Best Fit Role"),
    ],
    title= "Resume Analyzer based on JD",
    description="upload your resume and paste the job description to get you ATS match score and recommendations!",
    theme="default"
)
